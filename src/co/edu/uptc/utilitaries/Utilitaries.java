...
public class Utilitaries {
    ...
    public ArrayList<Movie> loadMovies() {
        ...
        listMovies.add(new Movie("Avengers: Endgame", "Los vengadores defenderan la realidad", 195,
                new ArrayList<>(Arrays.asList("Robert", "Hemworth", "Carolina")), "Ficción"));
        listMovies.add(new Movie("Avengers: Endgame", "Los vengadores defenderan la realidad", 120,
                new ArrayList<>(Arrays.asList("Robert", "Hemworth", "Carolina")), "Ficción"));
        listMovies.add(new Movie("El caballero de la noche", "una nueva entrega de nuestro superhéroe enmascarado", 120,
                new ArrayList<>(Arrays.asList("Robert", "Hemworth", "Carolina")), "Ficción"));
        listMovies.add(new Movie("El origen", "Dom Cobb (DiCaprio) es un experto en el arte de apropiarse", 120,
                new ArrayList<>(Arrays.asList("Robert", "Hemworth", "Carolina")), "Ficción"));
        listMovies.add(new Movie("Tiempos Violentos", "Tiempos Violentos narra tres historias intercaladas", 120,
                new ArrayList<>(Arrays.asList("Robert", "Hemworth", "Carolina")), "Ficción"));
        listMovies.add(new Movie("Fight Club", "Dolph Lundgren se entrena un poco mientras ayuda a Rebecca", 120,
                new ArrayList<>(Arrays.asList("Robert", "Hemworth", "Carolina")), "Ficción"));
        listMovies.add(new Movie("Sueños de Libertad", "Andrew Dufresne es acusado del asesinato de su mujer", 120,
                new ArrayList<>(Arrays.asList("Robert", "Hemworth", "Carolina")), "Ficción"));
        listMovies.add(new Movie("El Padrino", "América, años 40", 120,
                new ArrayList<>(Arrays.asList("Robert", "Hemworth", "Carolina")), "Ficción"));
        listMovies
                .add(new Movie("Interstellar", "Inspirada en la teoría del experto en relatividad Kip Stepehen Thorne",
                        120, new ArrayList<>(Arrays.asList("Robert", "Hemworth", "Carolina")), "Ficción"));
        listMovies.add(
                new Movie("Matrix", " La película es cinética, atmosférica, visualmente impresionante y alucinante",
                        120, new ArrayList<>(Arrays.asList("Robert", "Hemworth", "Carolina")), "Ficción"));
        return listMovies;
    }

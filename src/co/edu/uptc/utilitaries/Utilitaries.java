...
public class Utilitaries {
        ...
        public ArrayList<Movie> loadMovies() {
                ...
                listMovies.add(new Movie("El Padrino", "América, años 40", 120,
                                new ArrayList<>(Arrays.asList("Robert", "Hemworth", "Carolina")),
                                new ArrayList<>(Arrays.asList("Robert", "Hemworth", "Carolina")), "Ficción"));
                listMovies.add(new Movie("Interstellar","Inspirada en la teoría del experto en relatividad Kip Stepehen Thorne",
                                120, new ArrayList<>(Arrays.asList("Robert", "Hemworth", "Carolina")),
                                new ArrayList<>(Arrays.asList("Robert", "Hemworth", "Carolina")),"Ficción"));
                listMovies.add(new Movie("Matrix"," La película es cinética, atmosférica, visualmente impresionante y alucinante",
                                120, new ArrayList<>(Arrays.asList("Robert", "Hemworth", "Carolina")),
                                new ArrayList<>(Arrays.asList("Robert", "Hemworth", "Carolina")),"Ficción"));
                return listMovies;
        }

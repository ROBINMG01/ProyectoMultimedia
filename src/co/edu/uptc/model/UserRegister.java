...
public class UserRegister {
    public static void main(String[] args) {
        ...
        while (!salir) {
            ...
            String opcion = JOptionPane.showInputDialog("Bienvenido al proyecto de multimedia\n"
                    ...
                    + "[3]. Buscar serie\n" + "[4]. Ver mis favoritos\n"
                    + "[5]. Ver mi historial de reproducciones\n"
    ...
    public static void mostrarCatalogoPeliculas() {
        // Catálogo de películas con año de lanzamiento y género
        ...
        peliculas.add("Star Wars: Episode IV - A New Hope (1977, Acción/Aventura)");
